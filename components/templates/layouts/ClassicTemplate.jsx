...
const ClassicTemplate = ({ template, resumeData, onDragEnd }) => {
  return (
    <TemplateContainer templateId={template.id} className="classic-layout">
      <DragDropContext onDragEnd={onDragEnd}>
        ...
        <div className={getLayoutClasses(template, 'container')}>
          ...
          <div className={getLayoutClasses(template, 'leftColumn')}>
            {template.sections.placement.left.includes('summary') && (
              <TemplateSummary 
                template={template}
                resumeData={resumeData}
              />
            ...
            {template.sections.placement.left.includes('education') && (
              <TemplateEducation 
                template={template}
                resumeData={resumeData}
              />
            ...
            {template.sections.placement.left.includes('skills') && (
              <TemplateSkills 
                template={template}
                resumeData={resumeData}
              />
            ...
            {template.sections.placement.left.includes('languages') && (
              <TemplateLanguages 
                template={template}
                resumeData={resumeData}
              />
            ...
            {template.sections.placement.left.includes('certifications') && (
          ...
          <div className={getLayoutClasses(template, 'rightColumn')}>
            ...
            {template.sections.placement.right.includes('experience') && (
              <TemplateWorkExperience 
                template={template}
                resumeData={resumeData}
              />
            ...
            {template.sections.placement.right.includes('projects') && (
              <TemplateProjects 
                template={template}
                resumeData={resumeData}
              />
