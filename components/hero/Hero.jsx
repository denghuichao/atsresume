                ...
                <div className="h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col justify-center items-center h-full text-center">
                        ...
                        <p className="text-gray-600 mb-4">
                            ATSResumeBuilder is an innovative resume builder that helps job seekers create a professional and optimized resume for applicant tracking systems. Our platform uses cutting-edge technology to analyze and optimize your resume for maximum visibility and success. Say goodbye to manual formatting frustration and wasted time, and Create your winning resume with ATSResumeBuilder today and get noticed by employers.
                        </p>
                        <Link href="/builder" className="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-bold text-lg hover:bg-blue-700 transition duration-200 hover:-translate-y-1 transform hover:shadow-lg">
                            Make My Resume
                        </Link>
                    </div>
                </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex bg-blue-50 border border-blue-200 rounded-lg shadow-lg p-4">
                            <GrOptimize className="text-8xl text-blue-600 mr-4" />
                        ...
                        <div className="flex bg-green-50 border border-green-200 rounded-lg shadow-lg p-4">
                            <GrFingerPrint className="text-8xl text-green-600 mr-4" />
                            <div className="flex flex-col gap-2">
                                <h1 className="text-2xl font-bold text-gray-800">
                                    Easy to use
                                </h1>
                        ...
                        <div className="flex bg-purple-50 border border-purple-200 rounded-lg shadow-lg p-4">
                            <MdMoneyOff className="text-8xl text-purple-600 mr-4" />
                            <div className="flex flex-col gap-2">
                                <h1 className="text-2xl font-bold text-gray-800">
                                    Free
                                </h1>
                        ...
                        <div className="flex bg-orange-50 border border-orange-200 rounded-lg shadow-lg p-4">
                            <DiResponsive className="text-8xl text-orange-600 mr-4" />
                            <div className="flex flex-col gap-2">
                                <h1 className="text-2xl font-bold text-gray-800">
                                    Mobile-friendly
                                </h1>
                        ...
                        <div className="flex bg-teal-50 border border-teal-200 rounded-lg shadow-lg p-4">
                        ...
                        <div className="flex bg-indigo-50 border border-indigo-200 rounded-lg shadow-lg p-4">
